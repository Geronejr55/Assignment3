...
toLowercase = function (grid, dictionary) {
...
search = function (current, past, row, col, grid, trie, finalSet) {
	let neighbors = [
		[0, 1],
		[1, 0],
		[0, -1],
...
validWord = function (current, trie) {
	let word2 = "";
	let curr = trie;
